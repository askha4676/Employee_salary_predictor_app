...
st.title("Data-Driven Salary Prediction Using Python & ML Algorithms🎓")
...
st.sidebar.markdown("---")
st.sidebar.text("Developed by: Mohd Asif Khan")
...
st.sidebar.markdown(
    ...
    <div style='text-align: center;'>
        <a href='https://github.com/askha4676' target='_blank' style='margin: 0 10px;'>
            <i class='fab fa-github' style='font-size: 24px; color: #333;'></i>
        </a>
        <a href='https://www.linkedin.com/in/mohd-asif-khan-448b1621a' target='_blank' style='margin: 0 10px;'>
